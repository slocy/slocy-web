...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'skt-black' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'skt-black' ),
		'repeat-y'  => __( 'Repeat Vertically', 'skt-black' ),
		'repeat'    => __( 'Repeat All', 'skt-black' ),
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'skt-black' ),
		'fixed'  => __( 'Fixed in Place', 'skt-black')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'skt-black' ),
		'italic'      => __( 'Italic', 'skt-black' ),
		'bold'        => __( 'Bold', 'skt-black' ),
		'bold italic' => __( 'Bold Italic', 'skt-black' )
		);
