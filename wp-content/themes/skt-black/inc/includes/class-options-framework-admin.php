...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Black Theme Options', 'skt-black' ),
			'menu_title' => __( 'Theme Options', 'skt-black' ),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'black-options',
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    ...
		    <div id="optionsframework" class="postbox"  style="width:72%; float:left;">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Save Options', 'skt-black' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'skt-black' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', 'skt-black' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
            ...
            <div class="meta-box-sortables ui-sortable">
                ...
                <div class="postbox">
                 ...
                 <div class="postbox">
                    ...
                    <div class="inside">
                        <p><em><?php _e('For documentation and support check this link','skt-black'); ?> : <strong><a href="<?php echo esc_url(SKT_THEME_DOC); ?>" target="_blank"><?php _e('Black Theme Documentation','skt-black'); ?></a></strong></em></p>
                    </div>
                </div>
	...
	function validate_options( $input ) {
		...
		if ( isset( $_POST['reset'] ) ) {
			add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', 'skt-black' ), 'updated fade' );
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', 'skt-black' ), 'updated fade' );
	}
