<div class="wrap kaira-upgrade-page-wrap">
    ...
    <table class="form-table">
        ...
        <tr>
            <th scope="row">
                <?php _e( 'Extra Styling Settings', 'topshop' ); ?>
            </th>
            <td>
                <a href="<?php echo $topshop_premium_link; ?>" target="_blank">
                    <img src="<?php echo get_template_directory_uri() . '/upgrade/images/extra-styling-settings.jpg'; ?>" alt="" class="kaira-page-img" />
                </a>
                <p class="description"><?php _e( 'On premium we\'ve also ebabled the option to choose your own color for the Navigation and the Footer.', 'topshop' ); ?></p>
            </td>
        </tr>
        <tr>
            <th scope="row">
